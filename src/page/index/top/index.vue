  ...
  <div class="avue-top">
    ...
    <div class="top-bar__right">
      <el-tooltip
        ...
        popper-class="top-tooltip-popover"
        placement="bottom"
      >
      ...
      <el-dropdown>
        ...
        <el-dropdown-menu slot="dropdown" class="top-menu-dropdown">
          <router-link to="/info/index">
            <el-dropdown-item>{{ $t("navbar.userinfo") }}</el-dropdown-item>
          </router-link>
...
// import { finereportLoginOut } from '@/api/report/report';
...
export default {
  ...
  methods: {
    ...
    logout() {
      ...
      // finereportLoginOut();
      // rabbit 退出
      this.$confirm(this.$t("logoutTip"), this.$t("common.tip"), {
