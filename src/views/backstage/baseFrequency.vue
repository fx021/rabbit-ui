        ...
        >
          ...
          >
            <template slot-scope="scope">
              {{ scope.row.code | filterOptions(frequencyOptions) }}
            </template>
          </el-table-column>
          <el-table-column
            prop="triggerTime"
...
export default {
  ...
  methods: {
    ...
    getFrequencyQueryList(data) {
      console.log(data);
      frequencyQueryList(data).then((res) => {
    ...
    // 新增按钮
    handleAdd() {
      this.$router.push({ path: "./newBaseFrequency" });
    },
    // 详情
    details(data) {
