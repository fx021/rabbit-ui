        ...
        <el-form ref="form" :model="form" :rules="rules">
          ...
          <div class="sublevel">
            <div class="content">
              ...
              <el-table
                ref="multipleTable"
                :data="form.equipmentStateRequestList"
                tooltip-effect="dark"
                style="width: 100%"
              >
                ...
                >
                  <template slot-scope="scope">
                    <span v-if="compileShow" class="imgBox">
                      <img
...
<script>
import { edit, queryDetailList } from "@/api/backstage/grouping.js";
...
export default {
  ...
  created() {
    this.$nextTick(() => {
      queryDetailList({ groupTypeId: this.$route.query.id }).then(res => {
        const {
          stateImageResponseList,
          groupTypeName,
          sort,
          isEffective
        } = res.data.data;
        this.form = {
          ...
          sort,
          isEffective,
          equipmentStateRequestList: stateImageResponseList
        };
        this.form.equipmentStateRequestList.forEach(ele => {
          if (ele.fileId) {
            ele.link = this.imgUrl + ele.fileId;
          }
        });
      });
    });
      ...
      if (this.compileShow) {
        ...
        this.$refs.form.validate(valid => {
          if (valid) {
            ...
            param.equipmentStateRequestList.forEach(ele => {
