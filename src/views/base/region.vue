    ...
    <el-col :span="15">
      <basic-container>
        <el-button-group>
          ...
          <el-button v-if="permission.region_import" type="primary" size="small"  icon="el-icon-download" @click="handleImport">导入</el-button>
          <el-button v-if="permission.region_export" type="primary" size="small" icon="el-icon-upload2" @click="handleExport">导出</el-button>
        ...
        regionOption: {
          ...
          column: [
            ...
            },
            {
              ...
              prop: "level",
              type: "radio",
              dicUrl: "/api/rabbit-system/dict/dictionary?code=region",
              props: {
                label: "dictValue",
                value: "dictKey"
              },
          ...
          column: [
            {
              ...
              action: "/api/rabbit-system/region/import-region"
            },
            {
              label: "数据覆盖",
              prop: "isCovered",
          ...
          column: [
            {
              ...
              dicUrl: '/api/rabbit-system/region/select',
              span: 24,
            },
            {
              label: '地市',
              ...
              dicFlag: false,
              dicUrl: '/api/rabbit-system/region/select?code={{key}}',
              span: 24,
            },
            {
              label: '区县',
    ...
    watch: {
      ...
      'excelForm.isCovered'() {
        if (this.excelForm.isCovered !== '') {
          ...
          column.action = `/api/rabbit-system/region/import-region?isCovered=${this.excelForm.isCovered}`;
        }
      }
    },
    computed: {
    ...
    methods: {
      ...
      handleExport() {
        this.$confirm("是否导出行政区划数据?", "提示", {
          ...
          window.open(`/api/rabbit-system/region/export-region?${this.website.tokenHeader}=${getToken()}`);
        });
      },
      handleTemplate() {
        window.open(`/api/rabbit-system/region/export-template?${this.website.tokenHeader}=${getToken()}`);
      },
    }
  };
</script>
