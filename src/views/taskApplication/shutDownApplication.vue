...
import { planExcludePage } from "@/api/taskApplication/shutDownApplication.js";
...
export default {
  ...
  mounted() {
    ...
    if (this.$route.params.planCode) {
      this.form.planCode = this.$route.params.planCode;
      this.searchData();
    }
  },
  activated() {
  ...
  methods: {
    ...
    searchData() {
      this.getQueryList({
        excludePlanTitle: this.form.excludePlanTitle,
